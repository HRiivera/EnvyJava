...
public class CaveArea extends BaseArea {
    ...
    public CaveArea(Handler handler, EntityManager entityManager) {
        ...
        this.entityManager.AddEntity(handler.newEnemy(Images.REnemyIdle,handler,750, 2000,"InWorldState","Rayquaza","Cave","EnemyTwo",999,100,999,25,10,20,20,10,20,10,1,1,"None","Fire",null,null)); // lvl 0 dificulty
        this.entityManager.AddEntity(handler.newEnemy(Images.GEnemyIdle,handler,1250, 800,"InWorldState","Groudon","Cave","EnemyThree",999,100,999,25,10,20,20,10,20,10,1,1,"None","Fire",null,null)); // lvl 0 dificulty

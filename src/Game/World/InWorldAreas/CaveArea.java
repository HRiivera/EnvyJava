...
public class CaveArea extends BaseArea {
    ...
    public CaveArea(Handler handler, EntityManager entityManager) {
        ...
        this.entityManager.AddEntity(handler.newEnemy(Images.REnemyIdle,handler,750, 2000,"InWorldState","Rayquaza","Cave","EnemyTwo",100,25,40,1,8,12,20,10,20,10,1,5,"None","Fire",null,null)); // lvl 0 dificulty

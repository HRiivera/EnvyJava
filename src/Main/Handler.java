...
import Game.Entities.Dynamics.EnemyThree;
...
//		width = DEFAULTWIDTH;
	...
	public BaseHostileEntity newEnemy(BufferedImage[] images,Handler handler, int xPosition, int yPosition, String state, String name, String area,
		...
		else if(typeOfEnemy.equals("EnemyThree")) {
			EnemyThree n = new EnemyThree(handler, xPosition, yPosition, state, name, area,images);
			n.setAcc(acc);
			n.setBuffs(buffs);
			n.setClass(Class);
			n.setCons(cons);
